...
<main>
    <section class="profile-box">
        <?php $fotoPrincipal = (function_exists('resolve_image_url') ? resolve_image_url($vf_anuncio['FPrincipal']) : ($vf_anuncio['FPrincipal'] ?: 'DAW/practica/imagenes/default-list.png')); ?>
    ...
    <section style="max-width:1100px;margin:1rem auto;padding:0 1rem;">
                    ...
                    <figure style="margin:0;background:#fff;border-radius:8px;overflow:hidden;border:1px solid rgba(0,0,0,0.04);box-shadow:var(--sombra);">
                        ...
                        <figcaption style="padding:8px;font-size:0.95rem;color:var(--color-texto);">
                            ...
                            <div style="margin-top:6px;">
                                <a href="editar_foto.php?id=<?php echo (int)$foto['IdFoto']; ?>" class="btn btn-small">Editar</a>
                                <a href="borrar_foto.php?id=<?php echo (int)$foto['IdFoto']; ?>&anuncio=<?php echo (int)$vf_anuncio['IdAnuncio']; ?>" class="btn btn-small btn-danger" onclick="return confirm('¿Borrar esta foto?');">Borrar</a>
                            </div>
                        </figcaption>
                    </figure>
                <?php endforeach; ?>
        ...
        <p style="margin-top:1rem;">
            <a href="anyadir_foto.php?id=<?php echo (int)$vf_anuncio['IdAnuncio']; ?>" class="btn">Añadir nueva foto</a>
